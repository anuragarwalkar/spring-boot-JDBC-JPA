...
INSERT INTO PERSON (id, name, location, birth_date) values (111, 'anurag', 'hydrabad', now());
INSERT INTO PERSON (id, name, location, birth_date) values (112, 'rahul', 'pune', now());
INSERT INTO PERSON (id, name, location, birth_date) values (113, 'shivaji', 'nagpur', now());
...
INSERT INTO COURSE (id, name, created_date, last_updated_date) values(111, 'React Native', now(), now());
INSERT INTO COURSE (id, name, created_date, last_updated_date) values(112, 'Angular', now(), now());
INSERT INTO COURSE (id, name, created_date, last_updated_date) values(113, 'Fuject', now(), now()); 
